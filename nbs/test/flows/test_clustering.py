...
from sciflow.test.test_clustering import traffic_percent, speed, workers, odbc_conn, model_level, min_date
...
class TestClusteringFlow(FlowSpec):
    ...
    @step
    def preprocess(self):
        results = preprocess(odbc_conn, self.model_level, self.min_date, self.traffic_percent)
