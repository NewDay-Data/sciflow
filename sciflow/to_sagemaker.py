...
__all__ = ['nb_to_sagemaker_pipeline', 'is_train_step', 'is_processing_step', 'write_pipeline_to_files',
           'write_track_flow', 'write_params', 'extract_step_vars', 'format_job_arguments', 'format_hyperparams',
           'format_arg', 'write_steps', 'write_track_capture', 'get_return_var_names', 'format_args',
...
def nb_to_sagemaker_pipeline(
    nb_path: Path, flow_path: Path, config, silent=True, track_experiment=True
):
    nb = read_nb(nb_path)
...
def generate_flows(config, track_experiment=True):
    ...
    for nb_path in nb_paths:
        nb_to_sagemaker_pipeline(nb_path,
