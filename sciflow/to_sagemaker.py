...
__all__ = ['nb_to_sagemaker_pipeline', 'is_train_step', 'is_processing_step', 'set_sm_params',
           'write_pipeline_to_files', 'write_params', 'write_sm_params', 'write_script_processor', 'extract_step_vars',
           'format_job_arguments', 'format_hyperparams', 'format_arg', 'write_steps', 'format_args',
           'generate_sagemaker_modules', 'write_step_tracker', 'write_preamble', 'generate_flows', 'sciflow_sagemaker']
...
def write_step_tracker(
    ...
    sm_module_file.write(f"{ind}{ind}if tracker:\n")
    sm_module_file.write(
        f"{ind}{ind}{ind}exc_type, exc_value, trace = sys.exc_info()\n"
    )
    sm_module_file.write(
        f'{ind}{ind}{ind}except_info = {{"exc_type": exc_type, "exc_value": exc_value, "trace": trace}}\n'
    )
    sm_module_file.write(
