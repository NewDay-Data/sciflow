# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/test/test_data_handling.ipynb.

# %% auto 0
__all__ = ['int_param', 'float_param', 'str_param', 'bool_param', 'input_path', 'model_path', 'dict_param', 'list_param', 'ones',
           'text', 'series_param', 'df_param', 'scalar', 'py_advanced', 'pandas']

# %% ../../nbs/test/test_data_handling.ipynb 2
# | export
...
# %% ../../nbs/test/test_data_handling.ipynb 3
# | export
...
# %% ../../nbs/test/test_data_handling.ipynb 4
# | export_step scalar


def scalar(int_param: int, float_param: float, str_param: str, bool_param: bool):
...
# %% ../../nbs/test/test_data_handling.ipynb 6
# | export_step py_advanced
...
# %% ../../nbs/test/test_data_handling.ipynb 8
# | export_step pandas
