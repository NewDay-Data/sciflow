...
# %% auto 0
__all__ = ['traffic_percent', 'workers', 'model_level', 'min_date', 'proc_image_uri', 'something', 'get_traffic_text',
           'get_experiment_segment', 'get_utterances', 'preprocess', 'Topics', 'fit', 'evaluate', 'serve_num_topics']

# %% ../../nbs/test/test_multistep.ipynb 2
# | export_step first
...
min_date = "2021-01-01"
proc_image_uri = "823878111748.dkr.ecr.eu-west-1.amazonaws.com/sagemaker-training-custom:dstk-training"
...
# %% ../../nbs/test/test_multistep.ipynb 16
...
# %% ../../nbs/test/test_multistep.ipynb 21
# | export_step fit
