# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/test/test_clustering_no_params.ipynb (unless otherwise specified).

__all__ = ['something', 'traffic_percent', 'speed', 'workers', 'connection', 'model_level', 'min_date',
...
def get_utterances(conn, model, min_date, traffic_percent):
...
def get_button_responses_filter(conn):
    ...
    """
    button_responses = query(conn, button_responses_query)
