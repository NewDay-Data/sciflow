...
__all__ = ['reqs_file_to_sep_str', 'run_sys_cmd', 'determine_dependencies', 'reqs_lines_to_sep_str',
           'update_requirements', 'create_conda_meta_file', 'delete_multiple_element', 'read_deploy_vars',
           'write_art_conda_envs_to_file', 'correct_pypirc', 'sciflow_prepare']
...
def run_sys_cmd(command, args, cwd, env=None):
...
def determine_dependencies(
    ...
    run_sys_cmd(command, args, out_dir)
