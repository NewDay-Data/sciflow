...
__all__ = ['bucket', 'dataset_key_prefix', 'data_path', 'hyperparameters', 'model_dir', 'preprocess',
...
def preprocess(data_path):
    ...
    columns = ["rings"] + feature_columns_names
    results = {
...
def fit(model_dir, train, validation, hyperparameters):
    logger = logging.getLogger()
    logger.setLevel(logging.INFO)
    logger.addHandler(logging.StreamHandler())
