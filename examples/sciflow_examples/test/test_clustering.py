# AUTOGENERATED! DO NOT EDIT! File to edit: complete_workflow.ipynb (unless otherwise specified).
...
def get_utterances(
    odbc_conn=None, model_level=None, min_date=None, traffic_percent=100
):
    """
...
def preprocess(odbc_conn=None, model_level=None, min_date=None, traffic_percent=100):
