...
from sciflow_examples.test.test_clustering import something, preprocess, fit, evaluate
from sciflow_examples.test.test_clustering import traffic_percent, workers, model_level, min_date
...
obs = AWSLakeObserver(project="sciflow_examples", experiment_name="test_clustering")
...
class TestClusteringFlow(FlowSpec):
    ...
    @step
    def preprocess(self):
        results = preprocess(self.odbc_conn, self.model_level, self.min_date, self.traffic_percent)
